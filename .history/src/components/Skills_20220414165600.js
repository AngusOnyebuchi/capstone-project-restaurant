...
export default function Skills() {
    return(
        <div name="skills" className="w-full bg-[#0a192f] text-gray-200">

            {/** Container */}
            <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
                <div>
                    <p className="text-4xl sm:text-4.5xl font-bold inline border-b-4 border-pink-600 ">Skills</p>
                ...
                <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8">
                    <div className="mx-auto shadow-md shadow-[#040c16] hover:scale-110 duration-300">
                        <FaHtml5 size={100} className="text-orange-300"/> 
                    ...
                    <div className="mx-auto shadow-md shadow-[#040c16] hover:scale-110 duration-300">
                        <FaCss3 size={100} className="text-blue-500"/> 
                        <p className="my-4 uppercase">Css</p>
                    </div>
                    <div className="mx-auto shadow-md shadow-[#040c16] hover:scale-110 duration-300">
                        <FaJsSquare size={100} className="text-yellow-300"/> 
                        <p className="my-4 uppercase">Javascript</p>
                    </div>
                    <div className="mx-auto shadow-md shadow-[#040c16] hover:scale-110 duration-300">
                        <FaReact size={100} className="text-blue-300"/> 
                        <p className="my-4 uppercase">React</p>
                    </div>
                    <div className="mx-auto shadow-md shadow-[#040c16] hover:scale-110 duration-300">
                        <FaBootstrap size={100} className="text-pink-300"/> 
                    ...
                    <div className="mx-auto shadow-md shadow-[#040c16] hover:scale-110 duration-300">
                        <FaGit size={100} className="text-pink-200"/> 
                        <p className="my-4 uppercase">Git</p>
                    </div>
                    <div className="mx-auto shadow-md shadow-[#040c16] hover:scale-110 duration-300">
                        <FaGithub size={100} className="text-white"/> 
