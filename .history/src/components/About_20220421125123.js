        ...
        <div name="about" className="w-full h-screen bg-[#0a192f] text-gray-300">
            <div className="flex flex-col justify-center items-center w-full h-full">
                ...
                <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
                    ...
                    <div>
                        <p className="text-md sm:text-lg">The desire to bring together flavours and taste from varied cultures to create
                        culinary dishes that caters to the vibrant palates of our customers started the journey that led to the birth of 
                        Angus Restaurant.
                        </p>
                        <p>
                            The essence of Angus Restaurant is to blend high quality food and exceptional service, typically found in a fine dining
                            establishment, with a casual restaurant arrangement.
                        </p>
                    </div>
                </div>    
            </div>
