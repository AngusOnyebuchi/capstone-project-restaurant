    ...
    return (
        <div name="home" className="w-full h-screen bg-[#0a192f] ">
            ...
            <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
               <p className="text-pink-600 mt-12 mb-2">My name is</p>
               ...
               <p className="text-[#8892b0] py-4 max-w-[700px]">I specialize in building and designing exceptional digital experiences. Currently I focus on building responsive websites et web applications and as well, working towards becoming a fullstack developer.</p>
               <div>
