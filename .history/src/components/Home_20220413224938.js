    ...
    return (
        <div name="home" className="w-full h-screen bg-[#0a192f] ">
            ...
            <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
               ...
               <div>
                   <button className="text-white border-2 px-6 py-3 my-3 flex items-center hover:bg-pink-600 hover:border-pink-600">View Work <span className="hover:rotate-90"><HiArrowNarrowRight className="ml-3 "/></span> </button>
               </div>
            </div>
        </div>
    )
