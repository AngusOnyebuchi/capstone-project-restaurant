    ...
    return (
        <div name="home" className="w-full h-screen bg-[#0a192f] ">
            ...
            <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
               ...
               <h1 className="text-4xl sm:text-7xl font-bold text-[#ccd6f6]">Angus Modum</h1>
               <h2 className="text-4xl sm:text-7xl font-bold text-[#8892b0]">I am a Frontend Web Developer </h2>
