    ...
    return (
        <div name="home" className="w-full h-screen bg-[#0a192f] ">
            ...
            <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
               ...
               <p className="text-[#8892b0] py-4 max-w-[700px]">Ranging from your special breakfast, lunch and dinner. We'll always give you the best</p>
               <div>
                   <button className="group text-white border-2 px-6 py-3 my-3 flex items-center hover:bg-pink-600 hover:border-pink-600">
                   <Link to="products" smooth={true} duration={500} >View products</Link>
