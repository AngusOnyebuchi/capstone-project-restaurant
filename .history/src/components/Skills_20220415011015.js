            ...
            <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
                ...
                <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8">
                    <div className="mx-auto shadow-md shadow-[#040c16] hover:scale-110 duration-300">
                        <FaHtml5 size={50} className="text-orange-300"/> 
                    ...
                    <div className="mx-auto shadow-md shadow-[#040c16] hover:scale-110 duration-300">
                        <FaJsSquare size={50} className="text-yellow-300"/> 
                    ...
                    <div className="mx-auto shadow-md shadow-[#040c16] hover:scale-110 duration-300">
                        <FaBootstrap size={50} className="text-pink-300"/> 
                    ...
                    <div className="mx-auto shadow-md shadow-[#040c16] hover:scale-110 duration-300">
                        <FaGit size={50} className="text-pink-200"/> 
